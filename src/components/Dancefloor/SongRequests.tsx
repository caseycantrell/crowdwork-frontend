...
const SongRequests: React.FC<Props> = ({
  ...
  return (
    <div className="row-span-4 col-span-1 lg:col-span-3 pb-96">
       <p className='text-xl font-bold pl-4 py-1 bg-gray-900/80'>Now Playing</p>
        {nowPlayingSong ? (
          <div>  
          ...
          <div className='py-6 ml-8'>  
            <p className='text-lg italic font-semibold text-gray-400'>No song is currently set as playing.</p>
          </div>
        )}
      <div>
        {songRequestsError ? (
          ...
          <>
         <div className=''>
            <p className='text-xl font-bold pl-4 py-1 bg-gray-900/80'>Active Requests</p>
              {activeRequests.length > 0 ? (
                ...
                <p className='italic ml-8 font-semibold text-gray-400 my-6'>No active requests.</p>
              )}
            </div>
            <div className=''>
              <p className='text-xl font-bold pl-4 py-1 bg-gray-900/80'>Completed Requests</p>
              {completedRequests.length > 0 ? (
                ...
                <p className='italic ml-8 font-semibold text-gray-400 my-6'>No completed requests.</p>
              )}
            </div>
            <div className=''>
              <p className='text-xl font-bold pl-4 py-1 bg-gray-900/80'>Declined Requests</p>
              {declinedRequests.length > 0 ? (
                  ...
                  <p className='italic ml-8 font-semibold text-gray-400 my-6'>No declined requests.</p>
                )}
            </div>
          </>
        )}
